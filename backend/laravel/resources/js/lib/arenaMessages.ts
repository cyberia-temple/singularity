...
export const arenaMessages: Messages = {
    en: {
        ...
        scissors: 'Scissors',
        sealHint:
            'The move and random reveal secret are saved in this device’s wallet before signing. They are encrypted only if the wallet has a password.',
        seal: 'HOLD TO SEAL MOVE',
        revealHint: 'Reveal the move stored in this device’s wallet.',
        ...
        sealed: 'Move sealed on Cyberia; its reveal secret remains in this device’s wallet.',
    ...
    ru: {
        ...
        scissors: 'Ножницы',
        sealHint:
            'Ход и случайный секрет сохраняются в кошельке этого устройства до подписи. Они зашифрованы только при установленном пароле кошелька.',
        seal: 'УДЕРЖИВАЙТЕ, ЧТОБЫ СКРЫТЬ ХОД',
        revealHint: 'Раскройте ход, сохранённый в кошельке этого устройства.',
        ...
        sealed: 'Ход зафиксирован в Cyberia; секрет раскрытия сохранён в кошельке этого устройства.',
    ...
    zh: {
        ...
        scissors: '剪刀',
        sealHint:
            '选择和随机揭示密钥会在签名前保存在此设备的钱包中。只有钱包设置了密码时才会加密。',
        seal: '按住封存选择',
        revealHint: '揭示保存在此设备钱包中的选择。',
        reveal: '按住揭示',
        resolve: '结算对局',
        expire: '结算超时阶段',
        claim: '按住领取',
        ...
        sealed: '选择已记录在 Cyberia，揭示密钥保存在此设备的钱包中。',
        revealed: '选择已揭示。',
        settled: '游戏已结算。',
        claimed: '奖励已领取。',
        readError: '无法读取游戏',
